...
**Plans**: 5 plans
- [ ] 23-01-PLAN.md — BUG-01 clock consecutive-outlier recovery + RED→GREEN re-lock regression (Wave A)
- [ ] 23-02-PLAN.md — BUG-04 non-throwing parseSeedHex + dataFromJson hardening + BUG-03 gated display-swing store (Wave A)
- [ ] 23-03-PLAN.md — TEST-03 unit coverage: waveshape range grid, ratio/alignment table, swing math (Wave A)
- [ ] 23-04-PLAN.md — BUG-02 in-Rack x1.5/÷1.5 audition gate (BLOCKING human-verify; logs decision to STATE.md) (Wave B)
...
**Plans**: TBD
**UI hint**: yes
**Open decision at phase start**: RNG strategy — re-implement Xoroshiro128+ in the core for bit-identical drift fidelity (recommended) vs. template `DriftEngine` on an RNG type.
...
| 23. Functional Bug Fixes | v1.4 | 0/5 | Not started | - |
