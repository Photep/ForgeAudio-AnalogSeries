...
Plans:
- [ ] 20.1-01-PLAN.md — Wave 0: capture pre-change 14HP display baseline screenshots (Phase-20 regression reference)
- [ ] 20.1-02-PLAN.md — Wave 1: strip metal knob bodies from fresh.svg, promote to AnalogLFO.svg, delete dead artwork
